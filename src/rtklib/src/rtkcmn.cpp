...
const prcopt_t prcopt_default={ /* defaults processing options */
    ...
    0,1,0,0,1,1,                    /* sateph,modear,glomodear,bdsmodear */
...
solopt_t solopt_default={ /* defaults solution output options */
...
extern int readpcv(const char *file, pcvs_t *pcvs)
{
    ...
    if (!(strcpy(ext,strrchr(file,'.')))) ext="";
...
extern void createdir(const char *path)
{
    ...
    *p='\0';
	...
	//MultiByteToWideChar(CP_ACP, 0, buff, strlen(buff) + 1, wszClassName,
