...
#define PARMOPT "0:off,1:WN,2:FS,3:SRC"
#define FFRTOPT "0:off,1:on"
...
#define PHWOPT  "0:off,1:on,2:precise"
	...
	opt_t sysopts[] = {
		...
		{ "pos2-modear", 3, (void *)&prcopt_.modear, ARMOPT },
		{ "pos2-modepar", 3, (void *)&prcopt_.modepar, PARMOPT },
		{ "pos2-ffrt", 0, (void *)&prcopt_.ffrt, FFRTOPT },
	...
	{
		char str[32], *p = nullptr, *q = nullptr;
		int n;

		n = sprintf(str, "%d:", val);
		if (!strcpy(p, strstr(comment, str))) {
