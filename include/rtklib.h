...
#define PARMODE_OFF 0
#define PARMODE_WN 1                   // AR mode: triple carrier ar //
#define PARMODE_FS 2                   // AR mode: triple carrier ar //
#define PARMODE_SRC 3                   // AR mode: triple carrier ar //
...
typedef struct {        /* RTCM control struct type */
	...
	obs_t obs;// , obsc;          /* observation data (uncorrected) */
...
typedef struct {        /* processing options type */
	...
	int modepar;         // AR mode (0:off,1:WN,2:FS,3:SRC) //
	int ffrt;            // 是否采用基于失败率的阈值ratio //
...
extern "C" EXPORT solopt_t solopt_default; /* default solution output options */
...
extern "C" EXPORT opt_t sysopts[];              /* system options table */
//extern opt_t rcvopts[];              /* system options table */
//extern "C" EXPORT  int pppppp;
